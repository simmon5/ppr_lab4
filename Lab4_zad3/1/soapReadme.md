...
<tr><td><code><a href="#ns2__addResponse"> struct ns2__addResponse </a></code></td><td> calc.h:280 </td><td> yes </td></tr>
<tr><td><code><a href="#ns2__add"> struct ns2__add </a></code></td><td> calc.h:280 </td><td> yes </td></tr>
<tr><td><code><a href="#ns2__add2Response"> struct ns2__add2Response </a></code></td><td> calc.h:336 </td><td> yes </td></tr>
<tr><td><code><a href="#ns2__add2"> struct ns2__add2 </a></code></td><td> calc.h:336 </td><td> yes </td></tr>
<tr><td><code><a href="#SOAP_ENV__Header"> struct SOAP_ENV__Header </a></code></td><td> calc.h:397 </td><td> yes </td></tr>
<tr><td><code><a href="#SOAP_ENV__Code"> struct SOAP_ENV__Code </a></code></td><td> calc.h:397 </td><td> yes </td></tr>
<tr><td><code><a href="#SOAP_ENV__Detail"> struct SOAP_ENV__Detail </a></code></td><td> calc.h:397 </td><td> yes </td></tr>
<tr><td><code><a href="#SOAP_ENV__Reason"> struct SOAP_ENV__Reason </a></code></td><td> calc.h:397 </td><td> yes </td></tr>
<tr><td><code><a href="#SOAP_ENV__Fault"> struct SOAP_ENV__Fault </a></code></td><td> calc.h:397 </td><td> yes </td></tr>
</table>
...
This struct is declared in [calc.h](calc.h) at line 280, is serialized as XSD type *`ns2:addResponse`* and is internally used as the operation response element *`<ns2:addResponse>`* with the response parameters of service operation `ns2__add()`.
...
This struct is declared in [calc.h](calc.h) at line 280, is serialized as XSD type *`ns2:add`* and is internally used as the operation request element *`<ns2:add>`* with the request parameters of service operation `ns2__add()`.

[![][1] To top](#)


<a name="ns2__add2Response"></a>

### `struct ns2__add2Response`

This struct is declared in [calc.h](calc.h) at line 336, is serialized as XSD type *`ns2:add2Response`* and is internally used as the operation response element *`<ns2:add2Response>`* with the response parameters of service operation `ns2__add2()`.
...
This struct is declared in [calc.h](calc.h) at line 336, is serialized as XSD type *`ns2:add2`* and is internally used as the operation request element *`<ns2:add2>`* with the request parameters of service operation `ns2__add2()`.
...
This struct is declared in [calc.h](calc.h) at line 397, is recursive, meaning it may (in)directly reference itself through its (base or derived class) members, and is the SOAP protocol *`<SOAP-ENV:Code>`* element.  This struct is for internal use and will be auto-generated when not explicitly declared.
...
This struct is declared in [calc.h](calc.h) at line 397, is the SOAP protocol *`<SOAP-ENV:Reason>`* element.  This struct is for internal use and will be auto-generated when not explicitly declared.
...
This struct is declared in [calc.h](calc.h) at line 397, is the SOAP protocol *`<SOAP-ENV:Fault>`* element with fault information and details returned by a service that triggered the error.  At the server side, a fault can be explicitly set within a service operation by calling and returning:
...
<tr><td><code><a href="#ns2__add2"> struct ns2__add2 </a></code></td><td><code> ns2__add2 </code></td><td> struct </td><td> ns2:add2 </td></tr>
<tr><td><code><a href="#ns2__add2Response"> struct ns2__add2Response </a></code></td><td><code> ns2__add2Response </code></td><td> struct </td><td> ns2:add2Response </td></tr>
...
This service operation is declared in [calc.h](calc.h) at line 333 and has the following properties:
...
_Generated on Mon May 24 2021 15:32:53 UTC by soapcpp2 v2.8.35 for calc.h._
