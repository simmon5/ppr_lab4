...
#ifndef SOAP_TYPE_ns2__add2_DEFINED
#define SOAP_TYPE_ns2__add2_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns2__add2(struct soap*, struct ns2__add2 *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns2__add2(struct soap*, const struct ns2__add2 *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns2__add2(struct soap*, const char*, int, const struct ns2__add2 *, const char*);
SOAP_FMAC3 struct ns2__add2 * SOAP_FMAC4 soap_in_ns2__add2(struct soap*, const char*, struct ns2__add2 *, const char*);

SOAP_FMAC3 struct ns2__add2 * SOAP_FMAC4 soap_new_ns2__add2(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns2__add2(struct soap*, const struct ns2__add2 *, const char*, const char*);

#ifndef soap_write_ns2__add2
#define soap_write_ns2__add2(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns2__add2(soap, data), 0) || soap_put_ns2__add2(soap, data, "ns2:add2", "") || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns2__add2 * SOAP_FMAC4 soap_get_ns2__add2(struct soap*, struct ns2__add2 *, const char*, const char*);

#ifndef soap_read_ns2__add2
#define soap_read_ns2__add2(soap, data) ( ((data) ? (soap_default_ns2__add2(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns2__add2(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE_ns2__add2Response_DEFINED
#define SOAP_TYPE_ns2__add2Response_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns2__add2Response(struct soap*, struct ns2__add2Response *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns2__add2Response(struct soap*, const struct ns2__add2Response *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns2__add2Response(struct soap*, const char*, int, const struct ns2__add2Response *, const char*);
SOAP_FMAC3 struct ns2__add2Response * SOAP_FMAC4 soap_in_ns2__add2Response(struct soap*, const char*, struct ns2__add2Response *, const char*);

SOAP_FMAC3 struct ns2__add2Response * SOAP_FMAC4 soap_new_ns2__add2Response(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns2__add2Response(struct soap*, const struct ns2__add2Response *, const char*, const char*);

#ifndef soap_write_ns2__add2Response
#define soap_write_ns2__add2Response(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns2__add2Response(soap, data), 0) || soap_put_ns2__add2Response(soap, data, "ns2:add2Response", "") || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns2__add2Response * SOAP_FMAC4 soap_get_ns2__add2Response(struct soap*, struct ns2__add2Response *, const char*, const char*);

#ifndef soap_read_ns2__add2Response
#define soap_read_ns2__add2Response(soap, data) ( ((data) ? (soap_default_ns2__add2Response(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns2__add2Response(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
