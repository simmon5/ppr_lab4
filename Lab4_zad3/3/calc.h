...
/** Operation "ns2__add2" of service binding "calc".
Sums two values
...
//gsoap ns2  service method-protocol:	add2 SOAP
//gsoap ns2  service method-style:	add2 rpc
//gsoap ns2  service method-encoding:	add2 http://schemas.xmlsoap.org/soap/encoding/
//gsoap ns2  service method-action:	add2 ""
//gsoap ns2  service method-output-action:	add2 Response
int ns2__add2(
    char*                               :a,	///< Input parameter, : unqualified name as per RPC encoding
    char*                              *:result	///< Output parameter, : unqualified name as per RPC encoding
);
