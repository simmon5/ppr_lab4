...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.35 2021-05-24 15:31:01 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_ns2__add2:
		return soap_in_ns2__add2(soap, NULL, NULL, "ns2:add2");
	case SOAP_TYPE_ns2__add2Response:
		return soap_in_ns2__add2Response(soap, NULL, NULL, "ns2:add2Response");
	...
	*type = 0;
	...
	{	const char *t = soap->type;
		...
		if (!soap_match_tag(soap, t, "ns2:add2"))
		{	*type = SOAP_TYPE_ns2__add2;
			return soap_in_ns2__add2(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ns2:add2Response"))
		{	*type = SOAP_TYPE_ns2__add2Response;
			return soap_in_ns2__add2Response(soap, NULL, NULL, NULL);
		}
...
{	(void)tag;
	...
	case SOAP_TYPE_ns2__add2:
		return soap_out_ns2__add2(soap, tag, id, (const struct ns2__add2 *)ptr, "ns2:add2");
	case SOAP_TYPE_ns2__add2Response:
		return soap_out_ns2__add2Response(soap, tag, id, (const struct ns2__add2Response *)ptr, "ns2:add2Response");
	case SOAP_TYPE_ns2__add:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	{
	case SOAP_TYPE_ns2__add2:
		soap_serialize_ns2__add2(soap, (const struct ns2__add2 *)ptr);
		break;
	case SOAP_TYPE_ns2__add2Response:
		soap_serialize_ns2__add2Response(soap, (const struct ns2__add2Response *)ptr);
		break;
	case SOAP_TYPE_ns2__add:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns2__add2(struct soap *soap, struct ns2__add2 *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_string(soap, &a->a);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns2__add2(struct soap *soap, const struct ns2__add2 *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns2__add2(struct soap *soap, const char *tag, int id, const struct ns2__add2 *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns2__add2), type))
		return soap->error;
...
SOAP_FMAC3 struct ns2__add2 * SOAP_FMAC4 soap_in_ns2__add2(struct soap *soap, const char *tag, struct ns2__add2 *a, const char *type)
{
	size_t soap_flag_a = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns2__add2 *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns2__add2, sizeof(struct ns2__add2), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ns2__add2(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct ns2__add2 *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns2__add2, SOAP_TYPE_ns2__add2, sizeof(struct ns2__add2), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 struct ns2__add2 * SOAP_FMAC4 soap_new_ns2__add2(struct soap *soap, int n)
{
	struct ns2__add2 *p;
	struct ns2__add2 *a = (struct ns2__add2*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct ns2__add2));
	for (p = a; p && n--; p++)
		soap_default_ns2__add2(soap, p);
	return a;
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns2__add2(struct soap *soap, const struct ns2__add2 *a, const char *tag, const char *type)
{
	if (soap_out_ns2__add2(soap, tag ? tag : "ns2:add2", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct ns2__add2 * SOAP_FMAC4 soap_get_ns2__add2(struct soap *soap, struct ns2__add2 *p, const char *tag, const char *type)
{
	if ((p = soap_in_ns2__add2(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns2__add2Response(struct soap *soap, struct ns2__add2Response *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->result = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns2__add2Response(struct soap *soap, const struct ns2__add2Response *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns2__add2Response(struct soap *soap, const char *tag, int id, const struct ns2__add2Response *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns2__add2Response), type))
		return soap->error;
...
SOAP_FMAC3 struct ns2__add2Response * SOAP_FMAC4 soap_in_ns2__add2Response(struct soap *soap, const char *tag, struct ns2__add2Response *a, const char *type)
{
	size_t soap_flag_result = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns2__add2Response *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns2__add2Response, sizeof(struct ns2__add2Response), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ns2__add2Response(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct ns2__add2Response *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns2__add2Response, SOAP_TYPE_ns2__add2Response, sizeof(struct ns2__add2Response), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 struct ns2__add2Response * SOAP_FMAC4 soap_new_ns2__add2Response(struct soap *soap, int n)
{
	struct ns2__add2Response *p;
	struct ns2__add2Response *a = (struct ns2__add2Response*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct ns2__add2Response));
	for (p = a; p && n--; p++)
		soap_default_ns2__add2Response(soap, p);
	return a;
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns2__add2Response(struct soap *soap, const struct ns2__add2Response *a, const char *tag, const char *type)
{
	if (soap_out_ns2__add2Response(soap, tag ? tag : "ns2:add2Response", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct ns2__add2Response * SOAP_FMAC4 soap_get_ns2__add2Response(struct soap *soap, struct ns2__add2Response *p, const char *tag, const char *type)
{
	if ((p = soap_in_ns2__add2Response(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
